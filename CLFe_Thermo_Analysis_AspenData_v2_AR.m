...
Sheetnumber='Sheet1';
data=xlsread('CLFE_Thermo_Analysis_AspenData_recovered_v2_AR',Sheetnumber);
figure(3)
plot(data(:,1),data(:,7),'k:',data(:,1),data(:,8),'b-.','LineWidth',2)
set(gca,'FontSize',16,'TickLabelInterpreter','latex')
l=[legend('$\mathrm{O}_{2}$','$\mathrm{N}_{2}$') xlabel('$\mathrm{Air}$ to $\mathrm{CH_{4}}$ feed ratio') ylabel('Molar flow rate /$\mathrm{mol}$ $\mathrm{s}^{-1}$')]
set(l,'Interpreter','latex')

figure(4)
plot(data(:,1),data(:,2),'b',data(:,1),data(:,4),'r--',data(:,1),data(:,3),'r:',data(:,1),data(:,5),'r.-',data(:,1),data(:,6),'k','LineWidth',2)
set(gca,'FontSize',16)
l=[legend('$\mathrm{Fe}$','$\mathrm{Fe_{w}O}$','$\mathrm{Fe_{3}O_{4}}$','$\mathrm{Fe_{2}O_{3}}$','$\mathrm{C}$') xlabel('$\mathrm{Air}$ to $\mathrm{CH_{4}}$ feed ratio') ylabel('Molar flow rate /$\mathrm{mol}$ $\mathrm{s}^{-1}$')]
set(l,'Interpreter','latex')
...
dataread=xlsread('CLFE_Thermo_Analysis_AspenData_recovered_v2_AR',Sheetnumber);
data(:,:,k)=dataread;
end
